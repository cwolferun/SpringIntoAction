...
public class TodoTest {
    ...
    public void retrieveTodos() throws Exception {
        List<Todo> mockList = Arrays.asList(
                ...
                new Todo(2, "Bob", "Learn Spring Integration", new Date(), false));
        ...
        String expected = "["
                ...
                + "{id:2,user:Bob,desc:\"Learn Spring Integration\",done:false}" + "]";

        //false at the end turns off strict mode. It wont look for exact match.
    ...
    public void createTodo() throws Exception {
       ...
       mvc.perform(MockMvcRequestBuilders.post("/users/Jack/todos").content(todo)
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isCreated()).andExpect(header().string("location", containsString(
                        "/users/Jack/todos/" + CREATED_TODO_ID)));
